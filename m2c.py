...
def spit_out_note():
    # less than 10ms notes generate warning messages and will be rounded down to 0
    if (ms_per_tick * time_buffer) > 10:
...
def spit_out_delay():
    # less than 10ms delays generate warning messages and will be rounded down to 0
    if (ms_per_tick * time_buffer) > 10:
